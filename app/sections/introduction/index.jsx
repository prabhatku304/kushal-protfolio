...
import kushalProfile from '../../assets/kushal.webp'
...
export function WelcomeSection() {
	...
	const [text] = useState([
		"am a contemplative analyst, inspired by tough problems.",
		"have worked with automotive giant Toyota.",
		"have also been with insurance leaders LexisNexis"
	]);
			...
			<section id="intro" className="section" ref={introRef}>
				<div className="grid grid-cols-1 md:grid-cols-[1fr_0.5fr] lg:grid-cols-[1fr_0.7fr] gap-4 items-center">
					<div className="py-5 md:py-10">
						...
						>
							<p>
							Welcome to my page! My name is <mark> Kushal </mark> , I’ll take you to the alternate world of Data
							</p>
						</h1>
				...
				<div className="flex justify-end items-end">	
				 <Image src={kushalProfile} height={300} width={300} className="rounded-full h-[300px] w-[300px] object-cover" />
				 </div>
				</div>
			</section>
		</LazyMotion>
